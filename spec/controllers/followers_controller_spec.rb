...
describe FollowersController do
  ...
  let(:valid_attributes) { { "follower" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved follower as @follower" do
        ...
        post :create, {:follower => { "follower" => "invalid value" }}, valid_session
        assigns(:follower).should be_a_new(Follower)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested follower" do
        ...
        Follower.any_instance.should_receive(:update_attributes).with({ "follower" => "1" })
        put :update, {:id => follower.to_param, :follower => { "follower" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the follower as @follower" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Follower.any_instance.stub(:save).and_return(false)
        put :update, {:id => follower.to_param, :follower => { "follower" => "invalid value" }}, valid_session
        assigns(:follower).should eq(follower)
      end
